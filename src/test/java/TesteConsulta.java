...
public class TesteConsulta {
	...
	public static void main(String[] args) {
		...
		//
		//
		// Map<Date, BigDecimal> valores = valoresTotaisPorData(15, usuario,
		// sessao);
		//
		...
		//
		// // ex.: select date(data_criacao) as data, sum(valorTotal) as valor
		// from
		// // pedido where
		...
		// }
		//
		// private static Map<Date, BigDecimal> criarMapaVazio(Integer
		// numeroDeDias,
